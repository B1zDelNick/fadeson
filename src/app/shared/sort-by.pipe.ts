...
export class SortByPipe implements PipeTransform {
  ...
  private sortArray(value: any[], expression?: any, reverse?: boolean): any[] {
    ...
    let array: any[] = value.sort((a: any, b: any): number => {
      ...
      return SortByPipe.getValue(a, expression) > SortByPipe.getValue(b, expression) ? 1 : -1;
    });
  ...
  private transformObject(value: any | any[], expression?: any, reverse?: boolean): any {
    let parsedExpression = SortByPipe.parseExpression(expression);
    ...
    SortByPipe.setValue(value, newValue, parsedExpression);
    return value;
  }
